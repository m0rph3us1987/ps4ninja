...
namespace Be.Windows.Forms
{
	...
	public class HexBox : Control
	{
		...
		void PaintLineInfo(Graphics g, long startByte, long endByte)
		{
			...
			{
				ulong firstLineByte = (ulong)(((ulong)startByte + ((ulong)_iHexMaxHBytes) * (ulong)i) + _lineInfoOffset);
		...
		/// </summary>
		[DefaultValue((ulong)0), Category("Hex"), Description("Gets or sets the offset of the line info.")]
		public ulong LineInfoOffset
		{
